...
//     document.getElementById("TaskNo").value = allTasks[index].TaskNo;
//     document.getElementById("Task").value = allTasks[index].Task;
//     document.getElementById("Description").value = allTasks[index].Description;
...
//         completed: allTasks[gIndex].completed
//     };
